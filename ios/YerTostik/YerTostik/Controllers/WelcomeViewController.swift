...
class WelcomeViewController: UIViewController {
    ...
    lazy var signInButton: UIButton = {
        return UIButton(type: .system).then {
            $0.setTitle("Телефон номер арқылы кіру", for: .normal)
    ...
    func configureViews() {
        ...
        self.view.addSubviews(logoImageView, titleLabel, signInButton)
    }
    ...
    func configureConstraints() {
        ...
        logoImageView.easy.layout(Bottom(20).to(titleLabel), Size(60), Left(20))
        signInButton.easy.layout(Left(20), Right(20), Bottom(65))
    }
